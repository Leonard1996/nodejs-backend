...
export class UserService {
    ...
    static insert = async (userPayload: User) => {
        ...
        const { name, surname, email, password, role, profilePicture } = userPayload;
        ...
        const user = await userRepository.create({
            ...
            verifyToken: UUID(),
            tsVerifyTokenExpiration: Functions.getDateAfter(process.env.DURATION_ACTIVATION_TOKEN_HOURS, 'h'),
